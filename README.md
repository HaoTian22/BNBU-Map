...
POI: Updated at 3 AM daily via Overpass API following `Overpass.txt` query, by `fetch-poi.sh` (Source: [OSM](https://www.openstreetmap.org/))

Map Tiles: Updated manually (Source: [OSM](https://www.openstreetmap.org/))

HTML/JS/CSS: Updated at 4 AM daily, or as needed. (Source: This GitHub Repository)
